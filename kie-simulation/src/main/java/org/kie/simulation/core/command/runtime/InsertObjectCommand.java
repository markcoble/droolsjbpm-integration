...
package org.kie.simulation.core.command.runtime;
...
public class InsertObjectCommand implements ExecutableCommand<FactHandle>, IdentifiableResult {
    ...
    public FactHandle execute( Context context ) {
        ...
        if ( outIdentifier != null ) {
            ...
            ((RegistryContext) context).lookup( ExecutionResultImpl.class ).getFactHandles().put( this.outIdentifier,
                                                                                                  factHandle );
        }
    ...
    public String toString() {
        return "session.entryPoints(" + ((this.entryPoint == null) ? "DEFAULT" : this.entryPoint) + ").insert(" + object.toString() + ");";
    }
}
